create or replace PROCEDURE ttec_1044976_delete_reg_sal  IS
...
*/
  ...
  v_effective_date      DATE := '03-JUN-2018';
  ...
  v_delete_warning                   BOOLEAN;
	  ...
	  --END R12.2.10 Upgrade remediation
        ...
        AND peef.element_type_id  = 341 --IN (882,15619,860,857,5806,5803,885)  -- Basic Life for 882 ,Child Optnl Life 15619,Dental for  860, Health Care for 857,Enhanced Dental for  5806,Enhanced Health for 5803,LTD for 885
        ...
        AND pivf.name IN ('Periodic Salary')
        ...
        AND PAPF.EMPLOYEE_NUMBER = '1044976'
		AND peef.effective_start_date = '03-JUN-2018';
...
END ttec_1044976_delete_reg_sal;
/
show errors;
/